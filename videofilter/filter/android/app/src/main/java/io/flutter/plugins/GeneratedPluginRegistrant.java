...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new me.anharu.video_editor.VideoEditorPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin tapioca, me.anharu.video_editor.VideoEditorPlugin", e);
    }
    try {
